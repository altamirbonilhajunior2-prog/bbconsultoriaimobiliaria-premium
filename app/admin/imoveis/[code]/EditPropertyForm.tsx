          ...
          <div className="mt-8 border-t border-white/10 pt-7">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-500">
              {isAdmin
                ...
                : "Os responsáveis pela angariação são definidos exclusivamente pela administração."}
            </p>
              ...
              {isAdmin ? (
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex h-14 items-center border border-white/10 bg-[#111111] px-4 text-sm text-zinc-300">
                      {agents.find(
                        (agent) =>
                          agent.id ===
                          property.coCaptorId,
