    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/95 backdrop-blur-xl">
      <div className="mx-auto flex h-[96px] w-full max-w-[1800px] items-center gap-2 px-3 sm:h-[108px] sm:gap-3 sm:px-5 lg:h-[132px] lg:px-8 xl:h-[136px] xl:px-10">
        ...
        <div className="ml-auto hidden shrink-0 items-center justify-end gap-3 lg:flex">
          <Link
            href="/agendar-visita"
            className="inline-flex h-14 shrink-0 items-center justify-center whitespace-nowrap border border-[#D5A85A] px-5 text-center text-[10px] font-semibold uppercase tracking-[0.12em] text-[#D5A85A] transition-all duration-300 hover:bg-[#D5A85A] hover:text-black xl:h-16 xl:px-7 xl:text-[11px] 2xl:px-8"
          >
        ...
        <div className="ml-auto flex min-w-0 items-center justify-end gap-2 lg:hidden">
          <Link
            href="/agendar-visita"
            onClick={closeMenu}
            className="inline-flex h-10 shrink-0 items-center justify-center whitespace-nowrap border border-[#D5A85A] px-2.5 text-[7px] font-semibold uppercase tracking-[0.05em] text-[#D5A85A] transition hover:bg-[#D5A85A] hover:text-black sm:h-11 sm:px-4 sm:text-[9px] sm:tracking-[0.08em]"
          >
            Falar com um consultor
          </Link>
