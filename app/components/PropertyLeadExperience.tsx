    ...
    useCallback(
      (imageIndex: number) => {
        ...
        try {
          ...
          // O convite continua funcionando
          // mesmo se o navegador bloquear
          // o armazenamento da sessão.
        }
  ...
  const whatsappMessage =
    encodeURIComponent(
      `Olá, sou ${
        leadName ||
        "cliente"
      }. Acabei de demonstrar interesse no imóvel ${propertyCode} — ${propertyTitle}.`,
    );
